import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, version, unref, ref, watchEffect, watch, isShallow, isReactive, toRaw, h, defineAsyncComponent, defineComponent, resolveComponent, Suspense, mergeProps, Transition, provide, withCtx, createVNode, useSSRContext, createTextVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/aboutus-b886ec0b.js").then((m) => m.default || m)
  },
  {
    name: "areas-id",
    path: "/areas/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-b55480ab.js").then((m) => m.default || m)
  },
  {
    name: "companies-id",
    path: "/companies/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-a75309b7.js").then((m) => m.default || m)
  },
  {
    name: "companies",
    path: "/companies",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-954c025a.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contact-663602a6.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-7f90ec2f.js").then((m) => m.default || m)
  },
  {
    name: "people-id",
    path: "/people/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-fc95f7ed.js").then((m) => m.default || m)
  },
  {
    name: "people",
    path: "/people",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-d348c70b.js").then((m) => m.default || m)
  },
  {
    name: "topinvestments",
    path: "/topinvestments",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/topinvestments-b1986a9c.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/default-3bd64621.js").then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<main${_scopeId}><h1${_scopeId}>Ops, we are sorry, but something went wrong with your request</h1>`);
        ...
        return [
          createVNode("main", null, [
            createVNode("h1", null, "Ops, we are sorry, but something went wrong with your request"),
